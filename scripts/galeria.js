;(function(){
	...
	function Gallery( gallery ){
		...
		for(; i<l; i++){
			...
			img.setAttributes({
				'src' : images[i].src || images.src,
				'alt' : images[i].alt || images.alt,
				'width': images[i].width || images.width,
				'height' : 'auto',
				'style' : 'right: '+images[i].data('thumb-view') || 'right: '+images.data('thumb-view')
			});
		...
		//function removeInterval(){ w.clearInterval( galleryInterval ); }
